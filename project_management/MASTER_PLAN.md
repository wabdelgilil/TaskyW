...
- [x] كثافة كروت المهام والشريط السفلي المطور (Task Card Density & 4-Tab Bottom Navigation) — الإصدار v3.2.0:
  - دعم نمطين لكروت المهام: عرض مريح تفصيلي (Comfortable) وعرض مضغوط عالي الكثافة في سطر واحد (Compact) لعرض أكثر من 10 مهام في الشاشة في نفس الوقت.
  - زر تبديل سريع لكثافة العرض أعلى قائمة المهام مع خيار دائم في قسم المظهر في شاشة الإعدادات، وحفظ التفضيل محلياً (SharedPreferences + SQLite).
  - هيكلة الشريط السفلي للهواتف المحمولة إلى 4 تبويبات مباشرة: **Tasks** (لعرض جميع المهام)، **Notes** (الملاحظات والخزائن)، **Finance** (الوحدة المالية والتسويات)، و **Settings** (الإعدادات العامة).
...
- [x] **ميزات تفاعلية متقدمة للجدول**:
  ...
  - [x] **تقسيم وتجميع الجدول بحسب المشاريع (Multi-Table Grouping by Project)**: شريط تبديل علوي لتقسيم جدول المهام لعدة جداول بيانات منفصلة لكل مشروع مع رأس إحصائي تفاعلي (أيقونة، عداد، نسبة إنجاز، شريط تقدم ملون) وقابلية طي وفرد الجداول وعزل المهام المستقلة في جدول خاص بها.
